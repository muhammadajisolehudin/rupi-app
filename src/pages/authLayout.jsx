		...
		<React.Fragment>
			<CssBaseline>
				<Grid container style={{ width: "100%", height: "100vh" }}>
					...
					>
						<img src={vektor} style={{ height: "12rem", width: "100%" }} aria-hidden="true" />
						...
						<Typography variant="body1" style={{ marginTop: "10px", textAlign: "center" }}>
							Cek saldo, transfer cepat dan aman, serta mutasi rekening bersama Rupi App. <br /> Semua jadi
							mudah dalam genggaman Anda!
						</Typography>
					</Grid>
				</Grid>
			</CssBaseline>
