...
export const InfoSaldoPage = () => {
	...
	const transferIncomeCategory = dataIncome?.categories.find(
	...
	const transferExpenseCategory = dataExpense?.categories.find(
		(category) => category.type === "TRANSFER"
	);
								...
								{activeSection === "Pemasukan" ? (
									...
									<>
										...
										<TransactionBox
											...
											data={tarikCategory}
											onClick={() =>
												handleOpen(dataTarikTunai, "Tarik Tunai", "Tarik Tunai", "debit", <CreditCardIcon />)
											}
										/>
									</>
								)}
