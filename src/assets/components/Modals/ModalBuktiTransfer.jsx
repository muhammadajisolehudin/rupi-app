import { Box, Typography, Divider, IconButton, Grid, Modal, Button, Paper } from "@mui/material";
		...
		<Modal open={open} onClose={onClose}>
			<Box sx={style}>
				<Box sx={{ position: "relative" }}>
					...
					>
						<IconButton size="small" onClick={onClose} aria-label="Tutup bukti transfer,">
							<CloseIcon />
						</IconButton>
					</Box>
					<Box sx={{ display: "flex" }}>
						...
						>
							<img src="/logo.png" alt="Element" style={{ width: 24, height: "auto" }} />
					...
					<Divider sx={{ my: 2, borderColor: "black" }} aria-hidden="true" />
					...
					<Paper
						elevetion={6}
						sx={{ display: "flex", justifyContent: "space-between", mt: 2, p: 1, borderRadius: 3 }}
					>
						<Button
							startIcon={<ShareIcon />}
							onClick={onShare}
							// variant="outlined"
							aria-label="Bagikan resi bukti transfer,"
						>
							Bagikan Resi
						</Button>
						<Button
							...
							onClick={onDownload}
							// variant="outlined"
							aria-label="Download bukti transfer berhasil,"
						>
							Download
						</Button>
					</Paper>
