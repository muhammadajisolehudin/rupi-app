					...
					>
						...
						>
							<Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
								...
								<img src={arrowDownIcon} alt="arrow down" style={{ width: "15px", height: "15px" }} />
							</Box>
							<Button
								sx={{ minWidth: "auto", padding: 0 }}
								onClick={handleCopy}
								aria-label={"Copy nomor rekening RupiApp " + account?.account_number}
							>
								<ContentCopyIcon />
							</Button>
						</Box>
						...
						>
							...
							>
								IDR{" "}
								<span style={{ fontWeight: "bold" }} aria-label={account?.balance}>
							...
							<Button
								...
								aria-label={isNominalVisible ? "Button tutup Nominal" : "Button tampilkan nominal"}
							>
